            ...
            <div class="col-md-3 text-center text-md-end mt-3 mt-md-0">
                ...
                <div>
                    <?php if ($is_own_profile): ?>
                        <a href="edit-profile.php" class="btn btn-primary rounded-pill px-4"><i class="fas fa-user-edit me-1"></i> Edit Profile</a>
                    <?php else: ?>
                        <a href="mentor-details.php?id=<?= $profile_user['id'] ?>" class="btn btn-primary rounded-pill px-4"><i class="fas fa-paper-plane me-1"></i> Send Request</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
